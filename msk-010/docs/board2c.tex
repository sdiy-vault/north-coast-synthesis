% $Id: board2c.tex 9493 2021-10-26 22:07:41Z mskala $

%
% MSK 010 Board 2, variant C build instructions
...
Install the two 390k$\Omega$ (orange-white-black-orange) resistors R33
and R41.

\noindent\includegraphics[width=\linewidth]{res-390kC.jpg}

Install the two 1.0M$\Omega$ (brown-black-black-yellow) resistors R36
and R44.  Do not confuse these with other power-of-ten values.

\noindent\includegraphics[width=\linewidth]{res-1MC.jpg}

Install the two 1.2M$\Omega$ (brown-red-black-yellow) resistors R7 and
R15.

\noindent\includegraphics[width=\linewidth]{{res-1.2MC}.jpg}

Install the two 1.8M$\Omega$ (brown-gray-black-yellow) resistors R34
and R42.

\noindent\includegraphics[width=\linewidth]{{res-1.8MC}.jpg}

Install the two 5.6M$\Omega$ (green-blue-black-yellow) resistors R8
and R16.

\noindent\includegraphics[width=\linewidth]{{res-5.6MC}.jpg}

Install the two 10M$\Omega$ (brown-black-black-green) resistors R35 and
R43.  Do not confuse these with other power-of-ten values.

\noindent\includegraphics[width=\linewidth]{res-10MC.jpg}
...
Install the four 0.1$\mu$F film capacitors C11, C12, C15, and C16.

\noindent\includegraphics[width=\linewidth]{{cap-0.1uC}.jpg}

Install the four 0.22$\mu$F film capacitors C1, C5, C13, and C17.

\noindent\includegraphics[width=\linewidth]{{cap-0.22uC}.jpg}

Install the four 0.47$\mu$F film capacitors C2, C6, C14, and C18.

\noindent\includegraphics[width=\linewidth]{{cap-0.47uC}.jpg}

Install the four 1.0$\mu$F film capacitors C3, C4, C7, and
C8.\footnote{This photo shows the 10$\mu$F capacitors already installed,
but that's really the next step.}

\noindent\includegraphics[width=\linewidth]{{cap-1.0uC}.jpg}
...
\noindent\includegraphics[width=\linewidth]{cap-10uC.jpg}
